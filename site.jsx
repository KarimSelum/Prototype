    ...
    <div className="os-page" style={{padding:'32px 40px 60px', maxWidth:1280, margin:'0 auto'}}>
      <div style={{display:'flex', alignItems:'baseline', justifyContent:'space-between', marginBottom:18}}>
        ...
        <div style={{display:'flex', gap:8, alignItems:'center'}}>
          ...
          <Pill tone="solid" size="md" onClick={()=>onToast({message:'Site preview shared', sub:'Link valid for 7 days'})}>Share preview</Pill>
        </div>
      </div>
      ...
      <div className="site-workspace" style={{display:'grid', gridTemplateColumns:'1fr 210px', gap:16, alignItems:'start'}}>
        ...
        <div style={{display:'flex', flexDirection:'column', gap:12}}>
          <VersionHistory version={version} onRestore={(v)=>onToast({message:`Restored v${v}`, sub:`Current edits saved as v${version+1}`})}/>
          <Card pad={0} style={{overflow:'hidden'}}>
